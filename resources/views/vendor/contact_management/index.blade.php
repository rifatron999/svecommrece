                    ...
                    @if(!$complain->isEmpty())
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ Str::limit($a_question->message, 50) }}</td>
                                <td class="text-left">
                                    <a href="" title="See Details" class="btn btn-default"> <i class="fas fa-file-invoice-dollar"></i></a>
                                    <a href="" title="Details" class="btn btn-primary"> <i class="fas fa-arrow-circle-right"></i></a>
                                </td>
                            </tr>
